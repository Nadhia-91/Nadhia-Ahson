...
def datafr():
    df = pd.read_csv("C:/Users/Dhia/Desktop/New folder/Airbnb_an.csv")
    return df

df= datafr()


select = option_menu(None, ["Home","Explore Data","About"],
...
if select == "Explore Data":
    ...
    with tab2:
        ...
        def datafr():
            df_a= pd.read_csv("C:/Users/Dhia/Desktop/New folder/Airbnb_an.csv")
            return df_a
